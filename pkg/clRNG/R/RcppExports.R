...
cpp_rnormGpu <- function(xR, streamsR, max_global_size, max_local_size, type) {
    .Call('_clRNG_cpp_rnormGpu', PACKAGE = 'clRNG', xR, streamsR, max_global_size, max_local_size, type)
}
