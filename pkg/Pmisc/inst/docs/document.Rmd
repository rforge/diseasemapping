...
knitr::opts_chunk$set(
  ...
  fig.width=2.75, fig.height=2,  dpi=250, 
...
# consider adding
automatic-styles = '<style:style style:name="OLE" style:family="graphic"><style:graphic-properties text:anchor-type="paragraph" style:wrap="none"/></style:style>'
# to make equations better in odt document
```
