...
```{r testStream}
Nglobal = 4
streams = gpuRandom:::cpp_mrg31k3pCreateStreams((Nglobal));
t(streams)
```
...
gpuRandom::gpuRn(x, streams=streams, workgroupSize = Nglobal, random_type="normal")
...
system.time(streams <- gpuRandom::gpuRn(z, streams=streams, 
                                         workgroupSize = Nglobal,localSize = c(2,2),
                                         random_type="normal"))
```
