...
%\VignetteIndexEntry{Fisher's exact test}
-->
...
streams = gpuRandom:::cpp_mrg31k3pCreateStreams(stream_num)
...
gpuRandom::gpuFisher_test(a, b, results, #extraX, 
                          streams, workgroupSize = Nglobal)
