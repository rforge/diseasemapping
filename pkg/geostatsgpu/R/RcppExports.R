...
cpp_maternGpu <- function(varR, DofLDLR, coordsR, param, type, max_local_size) {
    .Call('_geostatsgpu_cpp_maternGpu', PACKAGE = 'geostatsgpu', varR, DofLDLR, coordsR, param, type, max_local_size)
}
