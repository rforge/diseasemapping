...
cpp_maternGpuD <- function(varR, DofLDLR, coordsR, param, form, max_local_size) {
    .Call('_geostatsgpu_cpp_maternGpuD', PACKAGE = 'geostatsgpu', varR, DofLDLR, coordsR, param, form, max_local_size)
}
