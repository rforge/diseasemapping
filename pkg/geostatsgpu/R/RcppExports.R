...
backsolveBatchBackend <- function(C, A, B, diagIsOne, Nglobal, Nlocal, NlocalCache) {
    .Call('_geostatsgpu_backsolveBatchBackend', PACKAGE = 'geostatsgpu', C, A, B, diagIsOne, Nglobal, Nlocal, NlocalCache)
}
...
crossprodBatchBackend <- function(C, A, D, invertD, Nglobal, Nlocal, NlocalCache) {
    .Call('_geostatsgpu_crossprodBatchBackend', PACKAGE = 'geostatsgpu', C, A, D, invertD, Nglobal, Nlocal, NlocalCache)
}
