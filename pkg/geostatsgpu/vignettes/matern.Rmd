...
diagWorking = gpuR::vclVector(0, 1 + round(control$workgroupSize / control$localWorkgroupSize),
            type='double',
            ctx_id = myMat@.context_index)
...
quantile(DfromR[SSeq] - as.vector(D)[SSeq])
