...
fit = lgcp(myLgcp$events, cell=30,covariates=torontoNightR,
		formula = ~layer, shape=2, buffer=10000,
...
@
<<saveSystemFile,eval=FALSE,echo=FALSE>>=
file.copy("fit.RData", "../inst/extdata/fit.RData",overwrite=TRUE)
@
