...
# compute Sexpected
kentucky = diseasemapping::getSMR(kentucky, larynxRates, larynx, regionCode="County")
@
...
$pr(\sqrt{\sigma_1^2+\sigma_2^2} > 1) = 0.05$ and $pr(\sigma_1/\sigma_0 < 0.2) = 0.95$.
