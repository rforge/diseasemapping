...
\subsection{Another likelihood}



\begin{align*}
\var(\mathbf{Y})^{-1}  = &[\xi^2 Q^{-1} + \tau^2 I]^{-1}\\
=&  \tau^2 Q [(\xi^2/\tau^2) + Q]^{-1}  \\
\end{align*}
...
-2 \log pr(\mathbf{Y};\phi,\tau^2/\xi^2) = & -N\log(N) + N \log (R)   -\log|Q| +
\log|V|+N
\end{align*}
