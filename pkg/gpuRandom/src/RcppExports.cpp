...
BEGIN_RCPP
    ...
    likfitGpu_BackendP(yx, coords, params, boxcox, betas, ssqY, ssqX, detVar, detReml, jacobian, NparamPerIter, workgroupSize, localSize, NlocalCache, verbose, ssqYX, LinvYX, QinvSsqYx, cholXVXdiag);
    return R_NilValue;
END_RCPP
}
// logfactsumBackend
