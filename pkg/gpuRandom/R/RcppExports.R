...
backsolveBatchBackend <- function(C, A, B, diagIsOne, Nglobal, Nlocal, NlocalCache) {
    .Call('_gpuRandom_backsolveBatchBackend', PACKAGE = 'gpuRandom', C, A, B, diagIsOne, Nglobal, Nlocal, NlocalCache)
}
...
#' @export
gemmBatchBackend <- function(A, B, C, z, zc, need_transpose, Nglobal) {
    .Call('_gpuRandom_gemmBatchBackend', PACKAGE = 'gpuRandom', A, B, C, z, zc, need_transpose, Nglobal)
}
