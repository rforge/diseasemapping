...
#  
#   gemmBatchBackend(a,c,aTc,nrow(paramsBatch),ncol(y), need_transpose=TRUE,Nglobal=workgroupSize2)
#  
#   e_beta<-vclMatrix(0, nrow(paramsBatch), ncol(y), type = gpuR::typeof(Vbatch)) 
#   
#   
#   
#   # gemmBatchBackend(a,e,ae,nrow(paramsBatch),ncol(y), need_transpose=TRUE,Nglobal=workgroupSize2)
#   gemmBatchBackend(b,e,be,nrow(paramsBatch),ncol(y), need_transpose=TRUE,Nglobal=workgroupSize2)
