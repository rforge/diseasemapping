...
#betas<-vclMatrix(c(-2.9590085,0.5520393,0.2788058),nrow=2, ncol=1,type="double")
...
temp1=gpuRandom::likfitGpu0(y,X,coordsGpu,paramsBatch,Vbatch,diagMat,betas,type="loglik",c(16,16,1),c(2,2,1), 50)
as.matrix(temp1)
