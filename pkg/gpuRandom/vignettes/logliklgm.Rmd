...
paramsBatch = cbind(newParam, otherparams)


paramsBatch = t(apply(paramsBatch, 1, geostatsp::fillParam))
paramsBatch = vclMatrix(cbind(paramsBatch, matrix(0, nrow(paramsBatch), 22-ncol(paramsBatch))),
                        type="double")

#list <- c("range", "shape", "variance", "nugget", "anisoRatio", "anisoAngleRadians")
#paramsBatch = paramsBatch[,list]
