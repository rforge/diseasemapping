...
workgroupSize = localSize = c(2,2,1)
NlocalCache=500
type='double'
verbose = 1L

paramsBatch = t(apply(params, 1, geostatsp::fillParam))
paramsBatch = vclMatrix(
  cbind(paramsBatch, matrix(0, nrow(paramsBatch), 22-ncol(paramsBatch))),
  type=type)
...
detReml = vclMatrix(0, Nparam, Ndata, type=type)
