...
SsubA = c(0,3,4,0,2,4) # A [rowStart, nRowsSub, nRowsTotal, colStart, ...]
SsubB = c(0,4,4,0,3,4) #B

gemmBatch2backend(
  gpuA, gpuB, outputCp,
  c(1,1,1), # transposeA, transposeB, transposeC
  SsubA, SsubB,
  c(0,SsubB[2],5,0,SsubA[2],5), #C
  c(2,2,0,0,0,0), # batches: nRow, nCol, recycleArow, recycleAcol, recycleB row col
  c(1,1,1,1,1,1), #workgroupSize  global 0 1 2, local 0 1 2  
  c(10,10), # cacheSizeA, cacheSizeB,                
  TRUE # verbose
  )
as.matrix(gpuA)
as.matrix(gpuB)
