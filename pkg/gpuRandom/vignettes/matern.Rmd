...
```{r plotSimNames}
theNames = apply(expand.grid('par',1:nrow(paramsGpu), 'sim', 1:ncol(simMat)), 1, paste, collapse='')
```
...
```{r plotSim, fig.height=5, fig.width=3, out.width=paste0(98/nrow(paramsGpu), '%'), fig.cap='simulations', fig.subcap = theNames, eval = exists('simRaster')}
par(mar=rep(0.1, 4))
