...
c(shape=2.15, range=0.5, variance = 2, nugget = 0.5, anisoRatio = 4, anisoAngleRadians = -pi/7),

c(shape=2.15, range=4, variance = 2, nugget = 0, anisoRatio = 2, anisoAngleRadians = pi/4))
