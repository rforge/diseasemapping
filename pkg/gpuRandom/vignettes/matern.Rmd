...
system.time(gpuRandom:::cholBatchBackend(
  outputChol, diagMat, 
  Nglobal = NglobalChol,
  Nlocal = NlocalChol,
...
```{r cholBatchCpu, include=FALSE, eval=TRUE}
...
```{r checkRange, eval=T, include=FALSE}
streams[1:3,1:6]
...
```{r plotSim, fig.height=5, fig.width=4, out.width="paste0(98/nrow(paramsGpu), '%')", fig.cap='simulations', fig.subcap = 'theNames', eval = T}
par(mar=rep(0.1, 4))
...
geostatsgpu:::backsolveBatchBackend(
