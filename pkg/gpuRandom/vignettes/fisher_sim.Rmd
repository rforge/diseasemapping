...
gpuRandom::fisher.sim(atable, 100000L, returnStatistics=FALSE, streams=streams, type="double", 
                      workgroupSize = Nglobal,verbose=TRUE)
#system.time(gpuRandom::fisher.sim(atable, 100000L, returnStatistics=FALSE, streams=streams,
                            # type="double", workgroupSize = Nglobal))
