...
system.time(fisher.test(atable, simulate.p.value = TRUE, B = 1e7))  ##72.596s on cpu, 250.825s on my cpu

atable<-vclMatrix(atable, type="integer")
res5<-gpuRandom::fisher.sim(atable, 10000000L, returnStatistics=FALSE, streams=streams, type="double", 
