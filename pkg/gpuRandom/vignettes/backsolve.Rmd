...
gpuRandom:::backsolveBatchBackend(gpuC, gpuA, gpuB, 
                                  c(0,3,2,2),c(0,3,0,3),c(0,3,0,2),2L,
                                  diagIsOne=FALSE, Nglobal, Nlocal, NlocalCache)
as.matrix(gpuC)
a<-gpuRandom::backsolveBatch(gpuC2, gpuA, gpuB, numbatchB=2L, diagIsOne=FALSE, Nglobal=c(8L,8L,4L), Nlocal=Nlocal, NlocalCache=NlocalCache)
as.matrix(a)
```
